...
const CarSection = () => {
  return (
    <section className="w-full h-[35vh] lg:h-[68vh] 2xl:h-[80vh] flex flex-col justify-start items-center mx-auto relative">
      <Image
      ...
      />
      <div className="absolute -bottom-4 lg:-bottom-60 whitespace-nowrap left-12 lg:left-1/3">
